...
%?- dupli([a,b,c,c,d],X), write(X),nl,fail.
...
%?- dupli([a,b,c],3,X), write(X),nl,fail.
...
%?- pack([a,a,a,a,b,c,c,a,a,d,e,e,e,e],X), write(X),nl,fail.
...
%?- encode([a,a,a,a,b,c,c,a,a,d,e,e,e,e],X), write(X),nl,fail.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Run-length encoding of a list (direct solution).
% Implement the so-called run-length encoding data compression method directly. I.e. don't explicitly create the sublists containing the duplicates, but only count them.
% Example:
% ?- encode_direct([a,a,a,a,b,c,c,a,a,d,e,e,e,e],X).
% X = [[4,a],b,[2,c],[2,a],d,[4,e]]

encode_direct(L1,L2):-
	encode_direct(L1,0,L2).
encode_direct([],0,[]).
encode_direct([H],N,[[H,N1]]):-
	N1 is N+1.
encode_direct([H,H|T],Acc,L):-
	Acc1 is Acc+1,
	encode_direct([H|T],Acc1,L).
encode_direct([H1,H2|T],Acc,L):-
	H1 \= H2,
	encode_direct([H2|T],0,L2),
	Acc1 is Acc+1,
	L = [[Acc1,H1]|L2].
	
%?- encode_direct([a,a,a,a,b,c,c,a,a,d,e,e,e,e],X), write(X),nl,fail.
...
%?- drop([a,b,c,d,e,f,g,h,i,k],3,X), write(X),nl,fail.
...
%?- split([a,b,c,d,e,f,g,h,i,k],3,L1,L2), write(L1),nl,write(L2),nl,fail.
...
%?- slice([a,b,c,d,e,f,g,h,i,k],3,7,L), write(L),nl,fail.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% WRITE trees in preorder, postorder and inorder

preorder(nil,[]).
preorder(t(X,Left,R),L):-
	preorder(Left,L1),
	preorder(R,L2),
	append([X|L1],L2,L).

inorder(nil,[]).
inorder(t(X,Left,R),L):-
	inorder(Left,L1),
	inorder(R,L2),
	append(L1,[X|L2],L).
...
%?- T=t(2,t(7,t(2,nil,nil), t(6, t(5,nil,nil), t(11,nil,nil))), t(5,nil, t(9, t(4,nil,nil),nil))), preorder(T,L), write(L), nl, fail. 

%?- T=t(2,t(7,t(2,nil,nil), t(6, t(5,nil,nil), t(11,nil,nil))), t(5,nil, t(9, t(4,nil,nil),nil))), inorder(T,L), write(L), nl, fail. 

%?- T=t(2,t(7,t(2,nil,nil), t(6, t(5,nil,nil), t(11,nil,nil))), t(5,nil, t(9, t(4,nil,nil),nil))), post(T,L), write(L), nl, fail. 
